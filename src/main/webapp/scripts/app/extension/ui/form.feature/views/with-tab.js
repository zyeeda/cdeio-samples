define({
    ...
    fieldGroups: {
        ...
        group2: [
            ...
            {name: 'field14', type: 'file-picker', url: 'invoke/sample/sub/first', label: 'File Picker', acceptFileTypes: /(\.|\/)(gif|jpe?g|png)$/i},
    ...
    form: {
        tabs: [
            {title: 'Group1 & Group2', groups: ['group1', 'group2']},
            {title: 'Group4 & Group5', groups: ['group4', 'group5']}
        ],
        groups: [
            {name: 'group1'},
            {name: 'group2', columns: 2},
            {name: 'group4'},
            {name: 'group5'}
        ]
    }
