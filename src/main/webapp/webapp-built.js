({    
  ...
  fileExclusionRegExp: /\.coffee$|\.orig$|\-built.js$/,

  skipDirOptimize: true,
	removeCombined: true,   //去除已经引用的js资源文件

	optimizeCss: "standard",
  normalizeDirDefines: "skip",

	deps: ['cdeio/vendors/jquery/jquery.slimscroll.min', 'vendors/prettify', 'vendors/marked.min'],
  ...
  shim: {
    ...
    'vendors/prettify': [],
    'vendors/marked.min': { exports: 'marked' },
    'vendors/ZeroClipboard': []
  }
})
