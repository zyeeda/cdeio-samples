exports.results = [
	...
	{id: "800", name: "实体", iconClass: "icon-key"},

	{id: "800003", name: "Scaffold 注解", /*iconClass: "green icon-key",*/ path: "#feature/entity/scaffold:test", parent: {id: "800", name: '实体'}},
	{id: "800002", name: "JPA", /*iconClass: "green icon-key",*/ path: "#feature/entity/scaffold:foo", parent: {id: "800", name: '实体'}},
	{id: "800004", name: "Bean Validation", /*iconClass: "green icon-key",*/ path: "#feature/entity/scaffold:bar", parent: {id: "800", name: '实体'}},
	...
	{id: "300001003", name: "回退", iconClass: "green icon-key", path: "#feature/generate/bpm/task/scaffold:reject", parent: {id: "300001", name: "任务"}},
    //{id: "300001004", name: "指定负责人", iconClass: "icon-lock", path: "#/", parent: {id: "300001", name: "任务"}},
	//{id: "300001005", name: "自由流", iconClass: "icon-lock", path: "#/", parent: {id: "300001", name: "任务"}},
	//{id: "300001006", name: "脚本任务", iconClass: "icon-lock", path: "#/", parent: {id: "300001", name: "任务"}},
	//{id: "300001007", name: "手工任务", iconClass: "icon-lock", path: "#/", parent: {id: "300001", name: "任务"}},
	//{id: "300001008", name: "Java服务任务", iconClass: "icon-lock", path: "#/", parent: {id: "300001", name: "任务"}},
	//{id: "300001009", name: "Java接收任务", iconClass: "icon-lock", path: "#/", parent: {id: "300001", name: "任务"}},
	{id: "300002", name: "网关", iconClass: "green icon-key", path: "#/", parent: {id: "100001008", name: "工作流"}},
	{id: "300002001", name: "排他网关", iconClass: "green icon-key", path: "#feature/generate/bpm/gateway/scaffold:exclusive", parent: {id: "300002", name: "网关"}},
	{id: "300002002", name: "并行网关", iconClass: "green icon-key", path: "#feature/generate/bpm/gateway/scaffold:parallel", parent: {id: "300002", name: "网关"}},
	//{id: "300002003", name: "包含网关", iconClass: "icon-lock", path: "#/", parent: {id: "300002", name: "网关"}},
	//{id: "300002004", name: "事件网关", iconClass: "icon-lock", path: "#/", parent: {id: "300002", name: "网关"}},
	{id: "300003", name: "监听", iconClass: "green icon-key", path: "#/", parent: {id: "100001008", name: "工作流"}},
	{id: "300003001", name: "流程监听", iconClass: "green icon-key", path: "#feature/generate/bpm/listener/scaffold:execution", parent: {id: "300003", name: "监听"}},
	{id: "300003002", name: "任务监听", iconClass: "green icon-key", path: "#feature/generate/bpm/listener/scaffold:task", parent: {id: "300003", name: "监听"}},
	{id: "300004", name: "子流程", iconClass: "green icon-key", path: "#/", parent: {id: "100001008", name: "工作流"}},
	{id: "300004001", name: "嵌入式子流程", iconClass: "green icon-key", path: "#feature/generate/bpm/subprocess/scaffold:embedded", parent: {id: "300004", name: "子流程"}},
	//{id: "300004002", name: "外部引用子流程", iconClass: "icon-lock", path: "#/", parent: {id: "300004", name: "子流程"}},
	{id: "300005", name: "多实例", iconClass: "green icon-key", path: "#/", parent: {id: "100001008", name: "工作流"}},
	{id: "300005001", name: "子流程", iconClass: "green icon-key", path: "#feature/generate/bpm/multiple/scaffold:subprocess", parent: {id: "300005", name: "多实例"}},
	{id: "300005002", name: "人工任务", iconClass: "green icon-key", path: "#feature/generate/bpm/multiple/scaffold:userTask", parent: {id: "300005", name: "多实例"}},
	//{id: "300005003", name: "脚本任务", iconClass: "icon-lock", path: "#/", parent: {id: "300005", name: "多实例"}},
	//{id: "300006", name: "中间事件", iconClass: "icon-lock", path: "#/", parent: {id: "100001008", name: "工作流"}},
	//{id: "300006001", name: "定时中间事件", iconClass: "icon-lock", path: "#/", parent: {id: "300006", name: "中间事件"}},
	//{id: "300006002", name: "消息中间事件", iconClass: "icon-lock", path: "#/", parent: {id: "300006", name: "中间事件"}},
	//{id: "300006003", name: "信号中间事件", iconClass: "icon-lock", path: "#/", parent: {id: "300006", name: "中间事件"}},
	//{id: "300006004", name: "错误中间事件", iconClass: "icon-lock", path: "#/", parent: {id: "300006", name: "中间事件"}},
	//{id: "300007", name: "边界事件", iconClass: "icon-lock", path: "#/", parent: {id: "100001008", name: "工作流"}},
	//{id: "300007001", name: "定时边界事件", iconClass: "icon-lock", path: "#/", parent: {id: "300007", name: "边界事件"}},
	//{id: "300007002", name: "消息边界事件", iconClass: "icon-lock", path: "#/", parent: {id: "300007", name: "边界事件"}},
	//{id: "300007003", name: "信号边界事件", iconClass: "icon-lock", path: "#/", parent: {id: "300007", name: "边界事件"}},
	//{id: "300007004", name: "错误边界事件", iconClass: "icon-lock", path: "#/", parent: {id: "300007", name: "边界事件"}},

	{id: "400", name: "扩展", iconClass: "icon-key"},
	{id: "400001", name: "后端功能", /*iconClass: "green icon-key",*/ path: "#/", parent: {id: "400", name: "扩展"}},

	{id: "400001001", name: "基础", iconClass: "green icon-key", path: "#feature/extension/service/scaffold:basic", parent: {id: "400001", name: "后台"}},
	{id: "400001003", name: "文件下载", iconClass: "green icon-cloud-download", path: "#feature/extension/service/scaffold:downloadfile", parent: {id: "400001", name: "后台"}},
	{id: "400001004", name: "文件上传", iconClass: "green icon-cloud-upload", path: "#feature/extension/service/scaffold:uploadfile", parent: {id: "400001", name: "后台"}},
	{id: "400001005", name: "SQL 查询", iconClass: "green icon-key", path: "#feature/extension/service/scaffold:sqlquery", parent: {id: "400001", name: "后台"}},
	//{id: "400001006", name: "全文检索", iconClass: "icon-lock", path: "#/", parent: {id: "400001", name: "后台"}},

	{id: "400002", name: "前端界面", /*iconClass: "green icon-key",*/ path: "#/", parent: {id: "400", name: "扩展"}},
	{id: "400002001", name: "基础", iconClass: "green icon-key", path: "#feature/extension/ui/scaffold:basic", parent: {id: "400002", name: "界面"}},
	{id: "400002002", name: "路由", iconClass: "green icon-key", path: "#feature/extension/ui/scaffold:router", parent: {id: "400002", name: "界面"}},
	/*{id: "400002003", name: "表单视图", iconClass: "green icon-key", path: "#feature/extension/ui/form", parent: {id: "400002", name: "界面"}},*/
	{id: "400002004", name: "自定义表单视图", iconClass: "green icon-key", path: "#feature/extension/ui/scaffold:custom-form", parent: {id: "400002", name: "界面"}},
	{id: "400002005", name: "自定义视图", iconClass: "green icon-key", path: "#feature/extension/ui/custom-view", parent: {id: "400002", name: "界面"}},
	{id: "400002006", name: "回调", iconClass: "green icon-key", path: "#feature/extension/ui/scaffold:call-back", parent: {id: "400002", name: "界面"}},
	...
	{id: "400003", name: "树", /*iconClass: "green icon-key",*/ parent: {id: "400", name: "扩展"}},
	{id: "400003001", name: "图标", iconClass: "green icon-key", path: "#feature/extension/tree/scaffold:icon", parent: {id: "400003", name: "树"}},
	{id: "400003002", name: "事件", iconClass: "green icon-key", path: "#feature/extension/tree/scaffold:event", parent: {id: "400003", name: "树"}},

	{id: "500", name: "报表", iconClass: "icon-bar-chart"},
