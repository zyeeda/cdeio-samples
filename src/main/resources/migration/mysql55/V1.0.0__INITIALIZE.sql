...
# Dump of table SA_EXTENSION_ADVANCED_TREE
# ------------------------------------------------------------
...
# Dump of table SA_FIELD_ACCOUNT
# ------------------------------------------------------------
...
# Dump of table SA_FIELD_PROJECT
# ------------------------------------------------------------
...
# Dump of table SA_GENERATE_BPM_GATEWAY_EXCLUSIVE
# ------------------------------------------------------------
...
# Dump of table SA_GENERATE_BPM_GATEWAY_PARALLEL
# ------------------------------------------------------------
...
# Dump of table SA_GENERATE_BPM_LISTENER_EXECUTION
# ------------------------------------------------------------
...
# Dump of table SA_GENERATE_BPM_LISTENER_TASK
# ------------------------------------------------------------
...
# Dump of table SA_GENERATE_BPM_MULTIPLE_SUBPROCESS
# ------------------------------------------------------------
...
# Dump of table SA_GENERATE_BPM_MULTIPLE_USERTASK
# ------------------------------------------------------------
...
# Dump of table SA_GENERATE_BPM_SUBPROCESS_EMBEDDED
# ------------------------------------------------------------
...
# Dump of table SA_GENERATE_BPM_TASK_CALLBACK
# ------------------------------------------------------------
...
# Dump of table SA_GENERATE_BPM_TASK_REJECT
# ------------------------------------------------------------
...
# Dump of table SA_GENERATE_BPM_TASK_USERTASK
# ------------------------------------------------------------
...
# Dump of table SA_SCAFFOLD_BASIC_TREE
# ------------------------------------------------------------
...
# Dump of table SA_SCAFFOLD_OPERATE_BUTTON
# ------------------------------------------------------------
...
# Dump of table SA_SENIORGRID_USER
# ------------------------------------------------------------
...
# Dump of table SA_SERVICE_DATAFILE
# ------------------------------------------------------------
...
# Dump of table SA_SERVICE_PERSON
# ------------------------------------------------------------
...
# Dump of table SA_UI_CUSTOM_FORM
# ------------------------------------------------------------
...
# Dump of table SA_UI_INLINE_GRID
# ------------------------------------------------------------
...
# Dump of table SA_VALIDATORS_USER
# ------------------------------------------------------------
...
# Dump of table SA_FIELD_TODO_ATTACHMENT
# ------------------------------------------------------------
...
# Dump of table SA_FIELD_TODO_USER
# ------------------------------------------------------------
...
# Dump of table SA_FORM_TODO_USER
# ------------------------------------------------------------
...
CREATE TABLE `SA_FORM_TODO_USER` (
  ...
  CONSTRAINT `FK_gv6ncva4iq9o037uu29rue2v6` FOREIGN KEY (`F_TODO_ID`) REFERENCES `SA_FORM_TODO` (`F_ID`),
  CONSTRAINT `FK_80xnx3dnop92hsxpw22sbi1k5` FOREIGN KEY (`F_USER_ID`) REFERENCES `SA_FORM_USER` (`F_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
# Dump of table CDE_ROLE_ACCOUNT
# ------------------------------------------------------------
...
# Dump of table CDE_ROLE_PERMISSION
# ------------------------------------------------------------
